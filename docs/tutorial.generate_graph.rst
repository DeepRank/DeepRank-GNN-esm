...
.. warning::
  ...
  Generation of esm embeddings see https://github.com/facebookresearch/esm
...
The following feature are optional, and computed only if embedding is used (see next example) :

- **embedding**: esm embedding of the residue
...
>>>
>>> GraphHDF5(pdb_path=pdb_path, pssm_path=pssm_path, embedding_path=embedding_path,
>>>           biopython=True, graph_type='residue', outfile='1ATN_residue.hdf5',
>>>           nproc=4)
...
>>> embedding_path = './data/embedding/1ATN/' # path to the embedding files
>>>
>>> GraphHDF5(pdb_path=pdb_path, pssm_path=pssm_path, embedding_path=embedding_path,
>>>           biopython=False, graph_type='residue', outfile='1ATN_residue.hdf5', nproc=4)
...
.. note::  
  The different input files must respect the following nomenclature:
   ...
   - esmbedding files: ``1ATN_xxx.A.pt`` or ``1ATN_xxx.B.pt``
